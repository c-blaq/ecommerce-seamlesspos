...
const Header: React.FC = () => {
  return (
    <header className="bg-white items-center h-16 lg:h-20 px-5">
      <div className="flex justify-between items-center gap-5 h-full w-full max-w-screen-2xl mx-auto py-4">
